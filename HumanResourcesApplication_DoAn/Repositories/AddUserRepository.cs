...
namespace HumanResourcesApplication_DoAn.Repositories
{
    ...
    {
        public void AddUser(string? userName, string? loginName, string? password, string? isAdmin, string? phoneNumber, string? dateOfBirth, string? country, string? education, string? gender, string? joinDate, string? role, string? payroll, string? facebook, string? twitter, string? linkedIn, string? email, string? avatar)
        {
            ...
            command.Parameters.Add("@education", MySqlDbType.VarString).Value = email;
            command.Parameters.Add("@email", MySqlDbType.VarString).Value = isAdmin;
            ...
            command.Parameters.Add("@department", MySqlDbType.VarString).Value = department;
